		...
		try {
			...
			// System.out.println(column +" = "+ row1 + " = " + row2 + " = "  + row3 + " = " + row4 + " = " + row5);
			 ...
			 //System.out.println(verVal1+" =\n " + verVal2 + " =\n " + verVal3 + "=\n" + verVal4 + " =\n " + verVal5 + " =\n " + verVal6+" =\n " + verVal7 + " =\n " + verVal8 + "=\n" + verVal9 + " =\n " + verVal10);
				 ...
				 xAvg.add(df.format(avgValue1/2));
				 xAvg.add(df.format(avgValue2/2));
				 xAvg.add(df.format(avgValue3/2));
				 xAvg.add(df.format(avgValue4/2));
				 xAvg.add(df.format(avgValue5/2));
				 xAvg.add(df.format(avgValue6/2));
				 xAvg.add(df.format(avgValue7/2));
				 xAvg.add(df.format(avgValue8/2));
				 xAvg.add(df.format(avgValue9/2));
				 xAvg.add(df.format(avgValue10/2));
				 ...
				 ps_check = conMaster.prepareStatement("SELECT *  FROM [SAPMaster].[dbo].[Baker_HeaderData] where id="+vo.getParameter());
				 rs_check = ps_check.executeQuery();
				 while (rs_check.next()) {
